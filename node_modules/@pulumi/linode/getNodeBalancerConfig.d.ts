 ...
 * ```
 */
export declare function getNodeBalancerConfig(args: GetNodeBalancerConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetNodeBalancerConfigResult>;
/**
 ...
 * ```
 */
export declare function getNodeBalancerConfigOutput(args: GetNodeBalancerConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNodeBalancerConfigResult>;
/**
 * A collection of arguments for invoking getNodeBalancerConfig.
 */
