 ...
 * ```
 */
export declare function getObjectStorageClusterOutput(args: GetObjectStorageClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetObjectStorageClusterResult>;
/**
 * A collection of arguments for invoking getObjectStorageCluster.
 */
