 ...
 * ```
 */
export declare function getObjectStorageQuota(args: GetObjectStorageQuotaArgs, opts?: pulumi.InvokeOptions): Promise<GetObjectStorageQuotaResult>;
/**
 ...
 * ```
 */
export declare function getObjectStorageQuotaOutput(args: GetObjectStorageQuotaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetObjectStorageQuotaResult>;
/**
 * A collection of arguments for invoking getObjectStorageQuota.
 */
